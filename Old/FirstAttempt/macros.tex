...
\newcommand\anyruleocc{\ruleocc{r}{x\rightarrow [[x^j_{i}]_j]_i}}
...
\newcommand\rfuncto{\scriptsize \ensuremath{\mathsf{(Functo)}}}
\newcommand\rrightarrow{\scriptsize \ensuremath{\mathsf{(\rightarrow)}}}
...
\newcommand{\LJ}{\ensuremath{\mathsf{LJ}}\xspace}
...
\newcommand{\muLK}{\ensuremath{\mu\mathsf{\LK}}\xspace}
\newcommand{\muLKi}{\ensuremath{\mu\mathsf{LK}^\infty}\xspace}
\newcommand{\muLKo}{\ensuremath{\mu\mathsf{LK}^\omega}\xspace}
\newcommand{\muLKstar}{\ensuremath{\mu}\LK\ensuremath{^\star}\xspace}
\newcommand{\muLKostar}{\ensuremath{\mu}\LK\ensuremath{^{\omega\star}}\xspace}
