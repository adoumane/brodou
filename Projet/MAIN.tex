...
\twocolumn[
\centerline{\Large A Curry-Howard Perspective On Cyclic Proofs: Case for Support} \vspace{0.2cm}
\centerline{James Brotherston (PI, UCL) and Amina Doumane}
\vspace{0.8cm}
]
